...
const TextBanner = () => {
  return (
    <div className="flex flex-col fontskr text-gradient  text-[1.5rem] md:text-[1.8rem] items-center justify-center xl:text-[2.3rem]">
      <span>Buy and Sell</span>
      <span>Console and Its Accessories</span>
